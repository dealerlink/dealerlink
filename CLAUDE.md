...
| Concern              | Pick                                     | Notes                                                                                                                                                                                                                                                                    |
| -------------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Hosting              | **DigitalOcean App Platform**, Bangalore | Web + workers both on DO App Platform components (BLR1 region). Web: basic-xs (buildpack). Workers: basic-xs in production, basic-xxs in staging (custom Dockerfile per ADR-013) — production was raised off 512 MB after it OOM-restarted under PDF rendering (DEV.67). |
