...
| C.1 | Provision 2 demo tenants via the admin app                                  | ⏳     |            | Use seed names: Demo Solar Distributors + Sample Industrial Co. (staging is currently seeded, not admin-provisioned) |
...
**Stage C status: 🔄 In progress (1/7) — staging live; validation tasks pending**
