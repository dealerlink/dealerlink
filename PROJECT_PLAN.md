...
|---|---|---|---|---|---|
| B.1 | Day 1 | Repo scaffold, design tokens, fonts, base layout (Sidebar + Topbar + Shell) | ⏳ | | |
...
*This plan is the canonical project tracker. When in doubt about what's done or what's next, this file wins.*
